...
<meta:doc xmlns:meta="rnib.org.uk/tbs#">
	<meta:revhistory>
		...
		<meta:revision>
			...
			<meta:date>7 April  2006</meta:date>
			<meta:authorinitials>JoelH</meta:authorinitials>
			<meta:revdescription>
	...
	<xsl:choose>
		...
		<xsl:when test="count($tag)&gt;0">
			<xsl:choose>
				...
				<xsl:when test="$tag/d:wrap and ($tag/d:wrap/@merge='false' or key('matchStyle', preceding::w:p[1]/w:pPr/w:pStyle/@w:val)/w:name/@w:val!=$styleName)">
